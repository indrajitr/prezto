...
01. Browse [*`modules`*][9] to see what is available.
02. Load the modules you need in *`${ZDOTDIR:-$HOME}/.zpreztorc`* and then open
...
03. Load the theme you like in *`${ZDOTDIR:-$HOME}/.zpreztorc`* and then
    open a new Zsh terminal window or tab.

    ![sorin theme][2]
    Note that the [*git*][11] module may be required for special symbols to
...
01. By default modules will be loaded from [*`/modules`*][9] and *`/contrib`*.
